namespace Zhivko_Servis
{
    public class Sedan : KopnenoVozilo
    {
        ...
        public Sedan(string tipNaGorivo) : base(tipNaGorivo)
        {
        }
        public Sedan(string tipNaGorivo, int kapacitetNaRezervoar) : base(tipNaGorivo, kapacitetNaRezervoar)
        {
        }

        public Sedan(string tipNaGorivo,
